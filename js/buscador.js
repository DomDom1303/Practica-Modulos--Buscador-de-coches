...
marca.addEventListener('input', e => {
    ...
    // Mandar a llamar funcion de filtrar autos
    filtrarAuto();
});
...
function mostrarAutos(autos){
    ...
    autos.forEach(auto => {
       ...
       autoHTML.innerHTML = `
       <p>${auto.marca} ${auto.modelo} - ${auto.year} - ${auto.puertas} Puertas - Transmision: ${auto.transmision} - Precio: ${auto.precio} - Color: ${auto.color}
       </p>
       `;
